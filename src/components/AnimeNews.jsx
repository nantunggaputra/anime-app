...
export default function AnimeNews() {
  ...
  const animeIds = [
    56785, 52742, 49785, 52196, 55855, 56840, 56840, 52299, 52299, 58488, 58488,
    53889, 53889, 57152, 57152, 55318, 55318, 58739, 58739, 58822, 58822, 58082,
    58082, 57616, 57616, 57557, 57557, 52093, 52093, 50613, 50613, 51122, 51122,
  ];
