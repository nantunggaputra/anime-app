 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,z){var M=P.length;P.push(z);e:for(;0<M;){var J=M-1>>>1,oe=P[J];if(0<i(oe,z))P[J]=z,P[M]=oe,M=J;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var z=P[0],M=P.pop();if(M!==z){P[0]=M;e:for(var J=0,oe=P.length,Hr=oe>>>1;J<Hr;){var Ut=2*(J+1)-1,Yo=P[Ut],Ht=Ut+1,Vr=P[Ht];if(0>i(Yo,M))Ht<oe&&0>i(Vr,Yo)?(P[J]=Vr,P[Ht]=M,J=Ht):(P[J]=Yo,P[Ut]=M,J=Ut);else if(Ht<oe&&0>i(Vr,M))P[J]=Vr,P[Ht]=M,J=Ht;else break e}}return z}function i(P,z){var M=P.sortIndex-z.sortIndex;return M!==0?M:P.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],u=[],f=1,h=null,y=3,w=!1,g=!1,v=!1,T=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(P){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=P)r(u),z.sortIndex=z.expirationTime,t(a,z);else break;z=n(u)}}function S(P){if(v=!1,m(P),!g)if(n(a)!==null)g=!0,Ko(j);else{var z=n(u);z!==null&&Qo(S,z.startTime-P)}}function j(P,z){g=!1,v&&(v=!1,p(O),O=-1),w=!0;var M=y;try{for(m(z),h=n(a);h!==null&&(!(h.expirationTime>z)||P&&!Qe());){var J=h.callback;if(typeof J=="function"){h.callback=null,y=h.priorityLevel;var oe=J(h.expirationTime<=z);z=e.unstable_now(),typeof oe=="function"?h.callback=oe:h===n(a)&&r(a),m(z)}else r(a);h=n(a)}if(h!==null)var Hr=!0;else{var Ut=n(u);Ut!==null&&Qo(S,Ut.startTime-z),Hr=!1}return Hr}finally{h=null,y=M,w=!1}}var N=!1,E=null,O=-1,q=5,F=-1;function Qe(){return!(e.unstable_now()-F<q)}function Un(){if(E!==null){var P=e.unstable_now();F=P;var z=!0;try{z=E(!0,P)}finally{z?Hn():(N=!1,E=null)}}else N=!1}var Hn;if(typeof d=="function")Hn=function(){d(Un)};else if(typeof MessageChannel<"u"){var Va=new MessageChannel,O0=Va.port2;Va.port1.onmessage=Un,Hn=function(){O0.postMessage(null)}}else Hn=function(){T(Un,0)};function Ko(P){E=P,N||(N=!0,Hn())}function Qo(P,z){O=T(function(){P(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,Ko(j))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return y},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(P){switch(y){case 1:case 2:case 3:var z=3;break;default:z=y}var M=y;y=z;try{return P()}finally{y=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,z){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var M=y;y=P;try{return z()}finally{y=M}},e.unstable_scheduleCallback=function(P,z,M){var J=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?J+M:J):M=J,P){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=M+oe,P={id:f++,callback:z,priorityLevel:P,startTime:M,expirationTime:oe,sortIndex:-1},M>J?(P.sortIndex=M,t(u,P),n(a)===null&&P===n(u)&&(v?(p(O),O=-1):v=!0,Qo(S,M-J))):(P.sortIndex=oe,t(a,P),g||w||(g=!0,Ko(j))),P},e.unstable_shouldYield=Qe,e.unstable_wrapCallback=function(P){var z=y;return function(){var M=y;y=z;try{return P.apply(this,arguments)}finally{y=M}}}})(Fc);Ac.exports=Fc;var tp=Ac.exports;/**
 * @license React
...
`;function ug({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Ha,iterationCount:i=1}){return E0`
  ...
  `}function cg(e){return e==null}function fg(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function R0(e,t){return n=>n?e():t()}function zr(e){return R0(e,()=>null)}function Ol(e){return zr(()=>({opacity:0}))(e)}const T0=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:i=1e3,fraction:o=0,keyframes:s=Ha,triggerOnce:l=!1,className:a,style:u,childClassName:f,childStyle:h,children:y,onVisibilityChange:w}=e,g=_.useMemo(()=>ug({keyframes:s,duration:i}),[i,s]);return cg(y)?null:fg(y)?se(pg,{...e,animationStyles:g,children:String(y)}):by.isFragment(y)?se(P0,{...e,animationStyles:g}):se(Iy,{children:_.Children.map(y,(v,T)=>{if(!_.isValidElement(v))return null;const p=r+(t?T*i*n:0);switch(v.type){case"ol":case"ul":return se(js,{children:({cx:d})=>se(v.type,{...v.props,className:d(a,v.props.className),style:Object.assign({},u,v.props.style),children:se(T0,{...e,children:v.props.children})})});case"li":return se(xc,{threshold:o,triggerOnce:l,onChange:w,children:({inView:d,ref:m})=>se(js,{children:({cx:S})=>se(v.type,{...v.props,ref:m,className:S(f,v.props.className),css:zr(()=>g)(d),style:Object.assign({},h,v.props.style,Ol(!d),{animationDelay:p+"ms"})})})});default:return se(xc,{threshold:o,triggerOnce:l,onChange:w,children:({inView:d,ref:m})=>se("div",{ref:m,className:a,css:zr(()=>g)(d),style:Object.assign({},u,Ol(!d),{animationDelay:p+"ms"}),children:se(js,{children:({cx:S})=>se(v.type,{...v.props,className:S(f,v.props.className),style:Object.assign({},h,v.props.style)})})})})}})})},dg={display:"inline-block",whiteSpace:"pre"},pg=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:i=0,duration:o=1e3,fraction:s=0,triggerOnce:l=!1,className:a,style:u,children:f,onVisibilityChange:h}=e,{ref:y,inView:w}=j0({triggerOnce:l,threshold:s,onChange:h});return R0(()=>se("div",{ref:y,className:a,style:Object.assign({},u,dg),children:f.split("").map((g,v)=>se("span",{css:zr(()=>t)(w),style:{animationDelay:i+v*o*r+"ms"},children:g},v))}),()=>se(P0,{...e,children:f}))(n)},P0=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:i,style:o,children:s,onVisibilityChange:l}=e,{ref:a,inView:u}=j0({triggerOnce:r,threshold:n,onChange:l});return se("div",{ref:a,className:i,css:zr(()=>t)(u),style:Object.assign({},o,Ol(!u)),children:s})};C`
  from,
  20%,
  40%,
  60%,
...
`;function _g(e,t,n){switch(n){case"bottom-left":return t?hg:Jy;case"bottom-right":return t?yg:Zy;case"down":return e?t?vg:tg:t?gg:eg;case"left":return e?t?xg:ng:t?wg:Ha;case"right":return e?t?kg:ig:t?Sg:rg;case"top-left":return t?Eg:og;case"top-right":return t?Cg:sg;case"up":return e?t?Ng:ag:t?jg:lg;default:return t?mg:qy}}const Rg=e=>{const{big:t=!1,direction:n,reverse:r=!1,...i}=e,o=_.useMemo(()=>_g(t,r,n),[t,n,r]);return se(T0,{keyframes:o,...i})};C`
  from {
