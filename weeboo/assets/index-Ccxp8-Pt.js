...
`;function ug({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Ha,iterationCount:i=1}){return E0`
  ...
  `}function cg(e){return e==null}function fg(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function R0(e,t){return n=>n?e():t()}function zr(e){return R0(e,()=>null)}function Ol(e){return zr(()=>({opacity:0}))(e)}const T0=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:i=1e3,fraction:o=0,keyframes:s=Ha,triggerOnce:l=!1,className:a,style:u,childClassName:f,childStyle:p,children:y,onVisibilityChange:x}=e,g=R.useMemo(()=>ug({keyframes:s,duration:i}),[i,s]);return cg(y)?null:fg(y)?se(pg,{...e,animationStyles:g,children:String(y)}):by.isFragment(y)?se(P0,{...e,animationStyles:g}):se(Iy,{children:R.Children.map(y,(v,T)=>{if(!R.isValidElement(v))return null;const m=r+(t?T*i*n:0);switch(v.type){case"ol":case"ul":return se(js,{children:({cx:d})=>se(v.type,{...v.props,className:d(a,v.props.className),style:Object.assign({},u,v.props.style),children:se(T0,{...e,children:v.props.children})})});case"li":return se(xc,{threshold:o,triggerOnce:l,onChange:x,children:({inView:d,ref:h})=>se(js,{children:({cx:S})=>se(v.type,{...v.props,ref:h,className:S(f,v.props.className),css:zr(()=>g)(d),style:Object.assign({},p,v.props.style,Ol(!d),{animationDelay:m+"ms"})})})});default:return se(xc,{threshold:o,triggerOnce:l,onChange:x,children:({inView:d,ref:h})=>se("div",{ref:h,className:a,css:zr(()=>g)(d),style:Object.assign({},u,Ol(!d),{animationDelay:m+"ms"}),children:se(js,{children:({cx:S})=>se(v.type,{...v.props,className:S(f,v.props.className),style:Object.assign({},p,v.props.style)})})})})}})})},dg={display:"inline-block",whiteSpace:"pre"},pg=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:i=0,duration:o=1e3,fraction:s=0,triggerOnce:l=!1,className:a,style:u,children:f,onVisibilityChange:p}=e,{ref:y,inView:x}=j0({triggerOnce:l,threshold:s,onChange:p});return R0(()=>se("div",{ref:y,className:a,style:Object.assign({},u,dg),children:f.split("").map((g,v)=>se("span",{css:zr(()=>t)(x),style:{animationDelay:i+v*o*r+"ms"},children:g},v))}),()=>se(P0,{...e,children:f}))(n)},P0=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:i,style:o,children:s,onVisibilityChange:l}=e,{ref:a,inView:u}=j0({triggerOnce:r,threshold:n,onChange:l});return se("div",{ref:a,className:i,css:zr(()=>t)(u),style:Object.assign({},o,Ol(!u)),children:s})};C`
  from,
  20%,
  40%,
  60%,
...
`;function _g(e,t,n){switch(n){case"bottom-left":return t?hg:Jy;case"bottom-right":return t?yg:Zy;case"down":return e?t?vg:tg:t?gg:eg;case"left":return e?t?xg:ng:t?wg:Ha;case"right":return e?t?kg:ig:t?Sg:rg;case"top-left":return t?Eg:og;case"top-right":return t?Cg:sg;case"up":return e?t?Ng:ag:t?jg:lg;default:return t?mg:qy}}const Rg=e=>{const{big:t=!1,direction:n,reverse:r=!1,...i}=e,o=R.useMemo(()=>_g(t,r,n),[t,n,r]);return se(T0,{keyframes:o,...i})};C`
  from {
